      ...
      <main className="pt-20">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0">
            <img src={villageImage} alt="खोपडा गाव" className="w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl">
              ...
              <p className="font-marathi text-lg text-card/80 animate-fade-in-up stagger-2">
                खोपडा हे एक प्रगत, शांत आणि संस्कारी गाव म्हणून ओळखले जाते
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="font-marathi text-muted-foreground leading-relaxed text-lg">
                  खोपडा हे गाव अमरावती जिल्ह्यातील एक छोटे आणि सुंदर गाव आहे. हे गाव मुख्यतः शेतीप्रधान आहे आणि येथील बहुतांश लोक शेतीवर आपला उदरनिर्वाह करतात. खोपडा गावात सोयाबीन, कापूस, हरभरा आणि गहू ही मुख्य पिके घेतली जातात. गावात शेतीसाठी नळ पाणी, विहिरी तसेच बोरवेल्सचा वापर मोठ्या प्रमाणावर केला जातो.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground font-marathi max-w-2xl mx-auto">
                खोपडा गावाची महत्वाची वैशिष्ट्ये
              </p>
            </div>
